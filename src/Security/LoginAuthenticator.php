...
class LoginAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey)
    {
        ...
        /* COURS 0- pour pouvoir faire une redirection selon le rôle de l'utilisateur, il faut utiliser la classe Security (cf. constructeur) */
        
        /* COURS 4- on peut définir une route de redirection selon le rôle de l'utilisateur qui vient de se connecter grâce à la méthode "isGranted" */
